...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	...
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="file_uploader.do" method="post" enctype="multipart/form-data" onSubmit="return false;">
        <div id="pop_content2">
		...
		<div id="pop_footer">
		    <div class="btn_area">
	            <a href="javascript:fn_imageUp();"><img src="${pageContext.request.contextPath}/smart_editor/img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
	            <a href="#"><img src="${pageContext.request.contextPath}/smart_editor/img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
	        </div>
    	</div>
        <!-- //content -->
    ...
    <div id="pop_container" class="pop_container" style="display:none;">
		...
		<form id="editor_upimage5" name="editor_upimage5" action="file_uploader.do" method="post" enctype="multipart/form-data" onSubmit="return false;">
        <div id="pop_content2">
			<input type="file" class="upload" id="uploadInputBox" name="Filedata">
            <p class="dsc" id="info"><strong>10MB</strong>이하의 이미지 파일만 등록할 수 있습니다.<br>(JPG, GIF, PNG, BMP)</p>
        </div>
