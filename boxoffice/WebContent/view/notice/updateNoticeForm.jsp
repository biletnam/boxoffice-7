...
<body>
	...
	<section>
		<div class="container center">
			<h2>공지사항 수정</h2>
			<form action="${pageContext.request.contextPath}/notice/update.do" class="form-horizontal" 
			method="post" enctype="multipart/form-data" name="noticeForm" onsubmit="return check();">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="n_title" name="n_title" value="${noticeVO.n_title}">
			    </div>
			  </div>
			  <div class="form-group">
			    <label for="n_contents" class="col-sm-2 control-label">내용</label>
			    <div class="col-sm-10">
			      <textarea class="form-control" rows="15" id="n_contents" name="n_contents">${noticeVO.n_contents}</textarea>	
			    </div>
			  </div>
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			    	...
			    	<p id="filetype">${noticeVO.n_file}</p>
			  ...
			  <input type="hidden" name="n_file2">
			</form>
		</div>
	</section>
	...
	<script type="text/javascript">
		...
		function check() {
			if(filetype == '' || filetype == null){
				$('input[name=n_file2]').val('${noticeVO.n_file}');
			}
		  ...
		  else if(filetype != 'gif' && filetype != 'jpg' && filetype != 'jpeg' && filetype != 'png' && filetype != 'pdf' && filetype != 'hwp' && filetype != "txt" && filetype != "" && filetype != null ){
